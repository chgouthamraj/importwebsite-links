...
function AdverseEventsScreen(props) {
  ...
  const data = [
      ...
      //   date: '9:50 am',
      //   type: 'out',
      //   message: 'i am feeling stomach Cramps ',
      //   img: profile,
      // },
    ...
    <View style={styles.container}>
      <FlatList
        ...
        renderItem={message => {
          ...
          let padStyle = inMessage ? styles.msgin : styles.msgout;
          return (
            <View
              style={{
                flexDirection: 'row',
              ...
              <View style={[styles.item, itemStyle, padStyle]}>
                {!inMessage && renderDate(item.date)}
                <View
                  style={[
                    styles.balloon,
                    inMessage ? styles.bgmin : styles.bgmout,
                  ]}>
                  <Text
                    style={{color: inMessage ? styles.txtin : styles.txtout}}>
                    {item.message}
                  </Text>
                </View>
                {inMessage && renderDate(item.date)}
...
export default AdverseEventsScreen;
